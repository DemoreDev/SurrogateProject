...
from mlfs.base_algorithms.scls import scls
...
class PyIT_SCLS(BaseEstimator, TransformerMixin):
    ...
    def __str__(self):
        return 'PYIT_SCLS('+str(self.n_features)+')'
    ...
    def fit(self, dfX, dfy=None):    
        ...
        self.index_ranks = scls().rank(X, y)
        return self

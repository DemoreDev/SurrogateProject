...
from mlfs.base_algorithms.mlsmfs import mlsmfs
...
class PyIT_MLSMFS(BaseEstimator, TransformerMixin):
    ...
    def __str__(self):
        return 'PYIT_MLSMFS('+str(self.n_features)+')'
    ...
    def fit(self, dfX, dfy=None):   
        ...
        self.index_ranks = mlsmfs().rank(X, y)
        return self
